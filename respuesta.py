...
class Respuesta:
    ...
    def detectar_accion_spotify(self, mensaje):
        ...
        # ==================================================
        # PALABRAS QUE INDICAN QUE SE QUIERE USAR SPOTIFY
        # ==================================================
        ...
        # ==================================================
        # COMPROBAR SI EL MENSAJE ES DE SPOTIFY
        # ==================================================

        es_spotify = any(
            palabra in texto
            for palabra in palabras_spotify
        )


        # ==================================================
        # TAMBIÉN DETECTAR PETICIONES MUSICALES
        # SIN MENCIONAR SPOTIFY
        # ==================================================
        ...
        es_peticion_musical = any(
            patron in texto
            for patron in patrones_musica
        )


        if not es_spotify and not es_peticion_musical:
        ...
        patrones_consulta = [
            ...
            r"(?:busca|buscar|búscame|buscame)\s+(.+?)(?:\s+en spotify)?$",

            r"(?:pon|ponme|reproduce|reprodúceme|reproduceme)\s+(.+?)(?:\s+en spotify)?$",

            r"(?:quiero escuchar|quiero oír|quiero oir)\s+(.+?)(?:\s+en spotify)?$",

            r"(?:escucha|escuchar)\s+(.+?)(?:\s+en spotify)?$"
        ...
        # ==================================================
        # QUITAR "EN SPOTIFY" SI QUEDÓ EN LA CONSULTA
        # ==================================================
        ...
        if not consulta:
            ...
            if (
                texto == "pon música"
                or texto == "pon musica"
                or texto == "quiero escuchar música"
                or texto == "quiero escuchar musica"
            ):
        ...
        # ==================================================
        # SI NO PUDIMOS OBTENER CONSULTA
        # ==================================================
    ...
    def generar(
        ...
        if accion_spotify:
            ...
            if tipo == "spotify_buscar":
                ...
                return {
                    ...
                    "respuesta":
                        f"Claro. Voy a buscar {consulta} en Spotify.",
        ...
        # ==================================================
        # IDENTIDAD — FORMATO PERSONALIZADO
        # ==================================================
        ...
        if (
            ...
            "mi color preferido es" in mensaje_lower
        ...
        if (
            ...
            "cual es mi color favorito" in mensaje_lower

            or

            "qué color me gusta" in mensaje_lower

            or

            "que color me gusta" in mensaje_lower
        ...
        if (
            ...
            "estoy construyendo lumy" in mensaje_lower
        ...
        if (
            ...
            "que recuerdas de mi" in mensaje_lower

            or

            "qué recuerdas sobre mí" in mensaje_lower

            or

            "que recuerdas sobre mi" in mensaje_lower
        ...
        if (
            ...
            "como me llamo" in mensaje_lower

            or

            "cuál es mi nombre" in mensaje_lower

            or

            "cual es mi nombre" in mensaje_lower
        ...
        if (
            ...
            "que pronombres uso" in mensaje_lower

            or

            "cuáles son mis pronombres" in mensaje_lower

            or

            "cuales son mis pronombres" in mensaje_lower
            ...
            if pronombres:
                ...
                return (
                    ...
                    f"Tus pronombres registrados son {pronombres}."
